...
// Update Frigo
$app->GET('/api/frigo/update/{id_user}/{id_ingrd}/{quantite}', function(Request $request, Response $response ,$args){
    ...
    $sql = "REPLACE into frigo(id_user,id_ingrd,quantite,id_unite) values($id_user,$id_ingrd,$quantite,1)";
